# Generated by Django 3.2 on 2023-06-04 10:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(reviews.models.current_year, message='Год издания не может быть больше текущего')], verbose_name='Год издания')),
        ...
        migrations.AddField(
            model_name='title',
            name='genre',
            field=models.ManyToManyField(related_name='titles', through='reviews.TitleGenres', to='reviews.Genre', verbose_name='Жанр'),
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
